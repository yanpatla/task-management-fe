    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          <input
            type="password"
            placeholder="Register Passoword"
            className="w-full p-3  border-gray-300 border"
            {...register("password", {
              required: "The password is required",
              minLength: {
                value: 8,
                message: "The password must be 8 characteres minumun",
              },
            })}
          />
          {errors.password && (
        ...
        <div className="flex flex-col gap-5">
          <label className="font-normal text-2xl">Password Repeat</label>

          <input
            id="password_confirmation"
            type="password"
            placeholder="Repeat the register password"
            className="w-full p-3  border-gray-300 border"
            {...register("password_confirmation", {
              required: "Repeat Password is required",
              validate: (value) =>
                value === password || "The password are not equals",
            })}
          />
